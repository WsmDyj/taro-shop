...
const SEARCH_TAB = [
  { sortName: '0', name: '综合排序' },
  { sortName: '2', name: '高佣金比' },
  { sortName: '4', name: '销量', sortType: '1' },
  { sortName: '1', name: '价格', sortType: '1' }
]
        ...
        <View className='screen-tabs'>
          {
            SEARCH_TAB.map((item, index) => {
              ...
              return (
                ...
                >
                  <Text
                    className={classNames('tab-item__name', active && 'tab-item__name--active')}
                  >
                    {item.name}
                  </Text>
                  {
                    item.sortType &&
                      <Image
                        ...
                        src={active ? (item.sortType === '2' ? down : up) : updown}
                      />
                  }
                </View>
              )
