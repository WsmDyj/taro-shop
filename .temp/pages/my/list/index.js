...
export default class Index extends Taro.Component {
  ...
  render() {
    return <View className="list">
        {NAV_LIST.map((item, index) => <View hoverClass="hoverClass" key={index} className="list-item" onClick={this.handleClick.bind(this, item)}>
              <View className="list-item__title">
                <Image src={item.img} className="list-item__title-img" />
