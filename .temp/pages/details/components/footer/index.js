...
import Taro, { switchTab as _switchTab, navigateToMiniProgram as _navigateToMiniProgram } from "@tarojs/taro-h5";
...
export default class Footer extends Taro.Component {
  ...
  render() {
    return <View className="item-footer">
        {NAV_LIST.map(item => <View key={item.key} className="item-footer__nav" onClick={this.handleClick.bind(this, item)}>
