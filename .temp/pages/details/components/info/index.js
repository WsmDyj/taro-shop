...
import Taro, { setClipboardData as _setClipboardData, previewImage as _previewImage, navigateToMiniProgram as _navigateToMiniProgram } from "@tarojs/taro-h5";
  ...
  render() {
    ...
    return <View className="info">
        ...
        <View className="info-coupons">
          {floatingAccSub(goodsInfo.referPrice, goodsInfo.salePrice) <= 0 ? <View className="info-coupons__buy">自购省¥ {goodsInfo.rebatePrice}</View> : <View className="info-coupons__share">
        ...
        <View className="info-price">
          {floatingAccSub(goodsInfo.referPrice, goodsInfo.salePrice) <= 0 ? <View className="info-price__coupons">
              ...
              </View> : <View className="info-price__coupons">
