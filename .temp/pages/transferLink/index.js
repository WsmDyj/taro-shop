...
export default class Index extends Taro.Component {
  ...
  render() {
    return <View className="transfer-link">
        <View className="transfer-link__textarea">
          <AtTextarea count={false} fixed showConfirmBar cursorSpacing={0} textOverflowForbidden={false} height={600} value={this.state.value} onChange={this.handleChange.bind(this)} placeholder="请输入待转链文本..." />
        </View>
