...
export default class SwiperBanner extends Taro.Component {
  ...
  render() {
    ...
    return <View className="home-menu">
        <Image className="home-menu-bg" src={homeMenuBg} mode="widthFix" />
        <View className="home-menu__list">
          <AtTabs scroll current={current} swipeable={false} animated={false} tabList={this.props.tabList} onClick={this.handleClick.bind(this)} />
        </View>
        ...
        <View onClick={() => this.setState({ open: false })} className={classNames('home-menu__content', open && 'home-menu__content-open')}>
          <View onClick={this.handleClick.bind(this)} className={classNames('home-menu__content-wrapper', open && 'home-menu__content-animation')}>
            ...
            <View className="home-menu__content-list">
              ...
              return <View onClick={this.handleClick.bind(this, item.cid)} className={classNames('home-menu__content-item', item.cid === current && 'home-menu__content-item--active')} key={index}>{item.title}</View>;
            })}
            </View>
          </View>
        </View>
