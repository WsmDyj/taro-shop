...
import Taro, { startPullDownRefresh as _startPullDownRefresh, stopPullDownRefresh as _stopPullDownRefresh } from "@tarojs/taro-h5";
...
export default @connect(state => state.home, { ...actions })
class Home extends Taro.Component {
  ...
  /* 下拉刷新 */
  onPullDownRefresh() {
    _startPullDownRefresh(setTimeout(_stopPullDownRefresh(), 2000));
  }
  ...
  render() {
    ...
    const _temp = <View className="home">
