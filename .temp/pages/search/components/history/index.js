...
export default class Index extends Taro.Component {
  ...
  render() {
    return <View className="search-history">
        ...
        <View className="search-history__list">
          {this.state.tags.map((item, index) => <Text onClick={this.selectTag.bind(this, item)} key={index} className="search-history__list--tag">{item}</Text>)}
        </View>
      </View>;
  }
}