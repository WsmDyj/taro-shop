...
export default class Index extends Taro.Component {
  ...
  render() {
    ...
    return <View className="feedback">
        ...
        <View className="feedback-section">
          ...
          <AtTextarea value={formData.content} onChange={this.handleConent.bind(this)} maxLength={500} height={200} placeholder="请描述您的问题或建议，如果有系统截图，请在添加图片上传截图，我们将尽快优化体验，感谢您的反馈" />
        </View>
        <View className="feedback-section">
          <Text className="feedback-section__title">添加图片(选填)</Text>
          <View className="feedback-section__conent">
            <AtImagePicker length={5} count={9} multiple files={formData.files} onChange={this.onChange.bind(this)} />
          </View>
        </View>
        <View className="feedback-section">
          <Text className="feedback-section__title feedback-bottom">联系方式(选填)</Text>
          <View className="feedback-section__conent">
            <AtInput border={false} type="phone" placeholder="手机号码" value={formData.phone}
