...
import Taro, { setClipboardData as _setClipboardData, previewImage as _previewImage } from "@tarojs/taro-h5";
import { View, Text } from '@tarojs/components';
import ImgLoader from "../imgLoader/index";
...
export default @connect(state => state.details, { onGoodsChange })
class Goods extends Taro.Component {
  ...
  render() {
    ...
    return <View className="goods">
        ...
        return <View key={data.itemId} className="goodsItem">
                <View className="goodsItem-content" onClick={this.handleClick.bind(this, data)}>
                  ...
                  <View className="goodsItem-info">
                    ...
                    <View className="goodsItem-info__coupons">
                      {data.coupons <= 0 ? <View className="goodsItem-info__coupons-buy">自购省¥ {data.rebatePrice}</View> : <View className="goodsItem-info__coupons-txt">券¥ {data.coupons}</View>}
                    </View>
